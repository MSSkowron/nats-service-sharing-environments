...
nats stream add --cluster natscluster --subjects 'lights.>,airconditioners.>,fridges.>,furnances.>,publishers.>' --retention limits --max-msg-size 1MB --max-msgs 1000 --max-bytes 1GB --storage file --discard old --replicas 3 devices
