...
# nats stream add --cluster natscluster --subjects 'orders.*' --retention limits --max-msg-size 1MB --max-msgs 1000 --max-bytes 1GB --storage file --discard old --replicas 3 orders